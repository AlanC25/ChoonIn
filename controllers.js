...
var LOGNS = 'APP ::';
var APP_ID = ' 132175';
var CHANNEL_URL = 'http://Choon In/channel.html'
...
$scope.playing_artist = 'Choon In';
$scope.playing_artist_link = 'http://connect.deezer.com/login.php?format=popup&callbackmethod=developers.onLogin';
...
break;
case 'artist':
DZ.api('/artist/' + encodeURIComponent($routeParams.id),
 function(response)
{
...
$scope.search_artists = response.data.slice(0, 5);
$scope.view = 'search';
$scope.$apply();
});
